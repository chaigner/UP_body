...
% 
% usage: [prbp, loadB1R_OK] = loadB1R(prbp)
%                   prbp        = struct with most problem related params
%                   loadB1R_OK  = flag to check if all maps were loaded
%
% Created by Christoph S. Aigner, PTB, June 2021.
% Email: christoph.aigner@ptb.de

function [prbp, loadB1R_OK] = loadB1R(prbp)
    ...
    prbp.allmaps     = allmaps;
    prbp.librarymaps = librarymaps;
    prbp.B1Dim       = B1Dim;
    prbp.Nc          = Nc;
    prbp.fov         = fov;
