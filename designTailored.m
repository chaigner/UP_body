...
function wvfrms = designTailored(pulseType, numkTpoints, numPhaseInit, lambdavec, phsinitmode, b_evalAllDatasets, numTailored, prbp) 
        ...
        for c_diffrand = numPhaseInit
            for c_lambdaexp=1:length(lambdavec)
                for c_dat = 1:numTailored
                    ...
                    maps.b1(:,:,(1:prbp.B1Dim(3)),:) = prbp.allmaps{c_dat}.b1;
                    maps.mask(:,:,(1:prbp.B1Dim(3))) = prbp.allmaps{c_dat}.mask;
                    maps.b0(:,:,(1:prbp.B1Dim(3)))   = prbp.allmaps{c_dat}.mask*0;
